/* tempate: [headerTable]="headerTable" [bodyTable]="bodyTable" [tableLength]="tableLength"
 */
...
export class FormReprovacaoComponent implements OnInit {
  ...
  tableDataModel!: MotivoReprovacao;
  arrayTableDataModel!: MotivoReprovacao[];
  columns: string[] = [];
  lenght!: number;
  dataSource!: any
  ...
  @Input('headerTable') headerTable!: string[];
  @Input('bodyTable') bodyTable!: MotivoReprovacao[];
  @Input('tableLength') tableLength!: number;
      ...
      next: (data) => {
        this.motivosReprovacaoService.getMotivosReprovacao(data).subscribe({
          next: (res:any) => {
            ...
            this.arrayTableDataModel = [...res?.bodyTable];
            this.lenght = res?.tableLength;

            this.dataSource = new MatTableDataSource(this.arrayTableDataModel);
  ...
  ngOnInit(): void {
    ...
    this.columns = [...this.headerTable];
    this.arrayTableDataModel = [...this.bodyTable];
    this.lenght = this.tableLength;
